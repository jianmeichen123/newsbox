...
public class Const {
	...
	//public static final String HTML_SERVER = "http://fxapp.galaxyinternet.com";		//线上   图片上传成功后与富文本生成后对应html服务器

	public static final String FILE_PATH = "/data/websites/fxapp_file/file";	//线上   图片文件保存的地址
	public static final String HTML_SERVER = "http://fx.dev.galaxyinternet.com/file";		//线上   图片上传成功后与富文本生成后对应html服务器
